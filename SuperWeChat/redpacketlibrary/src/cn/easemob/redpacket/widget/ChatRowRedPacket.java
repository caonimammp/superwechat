...
public class ChatRowRedPacket extends EaseChatRow {
    ...
    protected void onInflateView() {
        if (message.getBooleanAttribute(RPConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE, false)) {
            inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                    cn.easemob.redpacket.R.layout.em_row_received_red_packet : cn.easemob.redpacket.R.layout.em_row_sent_red_packet, this);
        }
    }

    @Override
    protected void onFindViewById() {
        mTvGreeting = (TextView) findViewById(cn.easemob.redpacket.R.id.tv_money_greeting);
        mTvSponsorName = (TextView) findViewById(cn.easemob.redpacket.R.id.tv_sponsor_name);
        mTvPacketType = (TextView) findViewById(cn.easemob.redpacket.R.id.tv_packet_type);
    }
    ...
    protected void onSetUpView() {
        ...
        if (!TextUtils.isEmpty(packetType) && TextUtils.equals(packetType, RPConstant.GROUP_RED_PACKET_TYPE_EXCLUSIVE)) {
            ...
            mTvPacketType.setText(cn.easemob.redpacket.R.string.exclusive_red_packet);
        } else {
