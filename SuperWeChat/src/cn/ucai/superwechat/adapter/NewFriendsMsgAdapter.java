...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            holder.agree = (Button) convertView.findViewById(cn.ucai.superwechat.R.id.agree);
		...
		String str7 = context.getResources().getString(cn.ucai.superwechat.R.string.refuse);
		String str8 = context.getResources().getString(cn.ucai.superwechat.R.string.invite_join_group);
        String str9 = context.getResources().getString(cn.ucai.superwechat.R.string.accept_join_group);
		String str10 = context.getResources().getString(cn.ucai.superwechat.R.string.refuse_join_group);
    ...
    private void refuseInvitation(final Button buttonAgree, final Button buttonRefuse, final InviteMessage msg) {
        final ProgressDialog pd = new ProgressDialog(context);
        String str1 = context.getResources().getString(cn.ucai.superwechat.R.string.Are_refuse_with);
        final String str2 = context.getResources().getString(cn.ucai.superwechat.R.string.Has_refused_to);
        final String str3 = context.getResources().getString(cn.ucai.superwechat.R.string.Refuse_with_failure);
        pd.setMessage(str1);
        pd.setCanceledOnTouchOutside(false);
        pd.show();
