...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(cn.ucai.superwechat.R.drawable.em_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(cn.ucai.superwechat.R.layout.em_image_grid_fragment,
				container, false);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(cn.ucai.superwechat.R.layout.em_choose_griditem, container,false);
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(cn.ucai.superwechat.R.drawable.em_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(cn.ucai.superwechat.R.drawable.em_empty_photo);
