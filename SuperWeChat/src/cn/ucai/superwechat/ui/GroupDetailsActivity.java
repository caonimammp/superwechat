...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout changeGroupDescriptionLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_change_group_description);
		...
		RelativeLayout blockOfflineLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_switch_block_offline_message);
		offlinePushSwitch = (EaseSwitchButton) findViewById(cn.ucai.superwechat.R.id.switch_block_offline_message);
		...
		ownerAdminAdapter = new OwnerAdminAdapter(this, cn.ucai.superwechat.R.layout.em_grid_owner, new ArrayList<String>());
		EaseExpandGridView ownerAdminGridview = (EaseExpandGridView) findViewById(cn.ucai.superwechat.R.id.owner_and_administrators_grid_view);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		final String st5 = getResources().getString(cn.ucai.superwechat.R.string.is_modify_the_group_name);
		...
		final String st8 = getResources().getString(cn.ucai.superwechat.R.string.is_modify_the_group_description);
		final String st9 = getResources().getString(cn.ucai.superwechat.R.string.Modify_the_group_description_successful);
		final String st10 = getResources().getString(cn.ucai.superwechat.R.string.change_the_group_description_failed_please);
	...
	private void refreshMembersAdapter() {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				membersAdapter = new GridAdapter(GroupDetailsActivity.this, cn.ucai.superwechat.R.layout.em_grid_owner, new ArrayList<String>());
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case cn.ucai.superwechat.R.id.rl_change_group_name:
				...
				break;
			case cn.ucai.superwechat.R.id.rl_change_group_description:
				startActivityForResult(new Intent(this, EditActivity.class).putExtra("data", group.getDescription()).
						putExtra("title", getString(cn.ucai.superwechat.R.string.change_the_group_description)), REQUEST_CODE_EDIT_GROUP_DESCRIPTION);
				break;
			case cn.ucai.superwechat.R.id.rl_search:
				...
				break;
			case cn.ucai.superwechat.R.id.rl_switch_block_offline_message:
...
//		final ArrayList list = (ArrayList) Arrays.asList(groupId);
	...
	Dialog createMemberMenuDialog() {
		...
		dialog.setContentView(cn.ucai.superwechat.R.layout.em_chatroom_member_menu);

		int ids[] = { cn.ucai.superwechat.R.id.menu_item_add_admin,
				cn.ucai.superwechat.R.id.menu_item_rm_admin,
				cn.ucai.superwechat.R.id.menu_item_remove_member,
				cn.ucai.superwechat.R.id.menu_item_add_to_blacklist,
				cn.ucai.superwechat.R.id.menu_item_remove_from_blacklist,
				cn.ucai.superwechat.R.id.menu_item_transfer_owner,
				cn.ucai.superwechat.R.id.menu_item_mute,
				cn.ucai.superwechat.R.id.menu_item_unmute};
							...
							try {
								switch (v.getId()) {
									...
									case cn.ucai.superwechat.R.id.menu_item_mute:
										...
										break;
									case cn.ucai.superwechat.R.id.menu_item_unmute:
										List<String> list = new ArrayList<String>();
										list.add(operationUserId);
										EMClient.getInstance().groupManager().unMuteGroupMembers(groupId, list);
										break;
									case cn.ucai.superwechat.R.id.menu_item_transfer_owner:
	...
	int[] ids = {
			cn.ucai.superwechat.R.id.menu_item_transfer_owner,
			cn.ucai.superwechat.R.id.menu_item_add_admin,
			cn.ucai.superwechat.R.id.menu_item_rm_admin,
			cn.ucai.superwechat.R.id.menu_item_remove_member,
			cn.ucai.superwechat.R.id.menu_item_add_to_blacklist,
			cn.ucai.superwechat.R.id.menu_item_remove_from_blacklist,
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (position == getCount() - 1) {
				...
				if (isInMuteList(username)) {
					...
					id_background.setBackgroundColor(convertView.getResources().getColor(cn.ucai.superwechat.R.color.holo_black));
				} else {
