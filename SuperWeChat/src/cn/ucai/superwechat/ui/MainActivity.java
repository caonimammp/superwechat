...
//		});
    ...
    private int getExceptionMessageId(String exceptionType) {
         if(exceptionType.equals(Constant.ACCOUNT_CONFLICT)) {
             return cn.ucai.superwechat.R.string.connect_conflict;
         } else if (exceptionType.equals(Constant.ACCOUNT_REMOVED)) {
             return cn.ucai.superwechat.R.string.em_user_remove;
         } else if (exceptionType.equals(Constant.ACCOUNT_FORBIDDEN)) {
             return cn.ucai.superwechat.R.string.user_forbidden;
         }
         return cn.ucai.superwechat.R.string.Network_error;
    }
	/**
		...
		if (!MainActivity.this.isFinishing()) {
			...
			try {
				if (exceptionBuilder == null)
				    ...
				    exceptionBuilder.setPositiveButton(cn.ucai.superwechat.R.string.ok, new DialogInterface.OnClickListener() {
