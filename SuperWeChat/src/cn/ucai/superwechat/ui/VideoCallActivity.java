...
//        recordBtn = (Button) findViewById(R.id.btn_record_video);
        ...
        Button captureImageBtn = (Button) findViewById(cn.ucai.superwechat.R.id.btn_capture_image);
                ...
                case NETWORK_DISCONNECTED:
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            netwrokStatusVeiw.setText(cn.ucai.superwechat.R.string.network_unavailable);
                        }
                    });
                    break;
                ...
                case DISCONNECTED: // call is disconnected
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            String s10 = getResources().getString(cn.ucai.superwechat.R.string.Refused);
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
        ...
        */
        ...
        case cn.ucai.superwechat.R.id.btn_switch_camera: //switch camera
            ...
            break;
        case cn.ucai.superwechat.R.id.btn_capture_image:
