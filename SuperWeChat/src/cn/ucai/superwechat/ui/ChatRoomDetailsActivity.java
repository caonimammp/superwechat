...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechat.R.layout.em_activity_chatroom_details);
		instance = this;
		...
		TextView chatRoomIdTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_chat_room_id_value);
		TextView chatRoomNickTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_chat_room_nick_value);
        ...
        RelativeLayout changeChatRoomNameLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_change_chatroom_name);
        RelativeLayout changeChatRoomDescriptionLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_change_chatroom_detail);
		...
		ownerAdminAdapter = new OwnerAdminAdapter(this, cn.ucai.superwechat.R.layout.em_grid_owner, ownerAdminList);
		EaseExpandGridView ownerAdminGridView = (EaseExpandGridView) findViewById(cn.ucai.superwechat.R.id.owner_and_administrators);
		...
		membersAdapter = new MemberAdapter(this, cn.ucai.superwechat.R.layout.em_grid_owner, memberMuteBlockList);
	...
	protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
		...
		String st2 = getResources().getString(cn.ucai.superwechat.R.string.is_quit_the_chat_room);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									TextView tv = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_chat_room_nick_value);
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
                            ...
                            TextView chatRoomTitle = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_chatroom_name);
							...
							Button destroyButton = (Button)ChatRoomDetailsActivity.this.findViewById(cn.ucai.superwechat.R.id.btn_destroy_chatroom);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case cn.ucai.superwechat.R.id.clear_all_history: // clear conversation history
				...
				break;
			case cn.ucai.superwechat.R.id.rl_change_chatroom_name:
				...
				break;
			case cn.ucai.superwechat.R.id.rl_change_chatroom_detail:
