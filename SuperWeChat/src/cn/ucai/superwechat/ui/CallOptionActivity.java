...
public class CallOptionActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(cn.ucai.superwechat.R.layout.em_activity_call_option);

        // EMClient.getInstance().callManager().getOptions().xxx set initial values resident at SuperWeChatHelper

        // min video kbps
        EditText editMinBitRate = (EditText)findViewById(cn.ucai.superwechat.R.id.edit_min_bit_rate);
        ...
        // max video kbps
        EditText editMaxBitRate = (EditText)findViewById(cn.ucai.superwechat.R.id.edit_max_bit_rate);
        ...
        // max frame rate
        EditText editMaxFrameRate = (EditText)findViewById(cn.ucai.superwechat.R.id.edit_max_frame_rate);
        ...
        // audio sample rate
        initAudioSampleRateSpinner(cn.ucai.superwechat.R.id.spinner_audio_sample_rate);

        /**
         * Back camera and front camera share the same API: EMCallOptions.setVideoResolution(w, h);
         */
        initCameraResolutionSpinner(Camera.CameraInfo.CAMERA_FACING_BACK, cn.ucai.superwechat.R.id.spinner_video_resolution_back);
        initCameraResolutionSpinner(Camera.CameraInfo.CAMERA_FACING_FRONT, cn.ucai.superwechat.R.id.spinner_video_resolution_front);


        // fixed sample rate
        RelativeLayout rlSwitchSampleRate = (RelativeLayout)findViewById(cn.ucai.superwechat.R.id.rl_switch_fix_video_resolution);
        rlSwitchSampleRate.setOnClickListener(this);
        EaseSwitchButton swFixedSampleRate = (EaseSwitchButton)findViewById(cn.ucai.superwechat.R.id.switch_fix_video_resolution);
        ...
        // offline call push
        RelativeLayout rlSwitchOfflineCallPush = (RelativeLayout)findViewById(cn.ucai.superwechat.R.id.rl_switch_offline_call_push);
        rlSwitchOfflineCallPush.setOnClickListener(this);
        EaseSwitchButton swOfflineCallPush = (EaseSwitchButton)findViewById(cn.ucai.superwechat.R.id.switch_offline_call_push);
        ...
        try {
            ...
            spinnerVideoResolution.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (position == 0) {
                        TextView textVideoResolution = (TextView)findViewById(cn.ucai.superwechat.R.id.text_video_resolution);
                    ...
                    if (size != null) {
                        ...
                        if (cameraId == Camera.CameraInfo.CAMERA_FACING_BACK) {
                            ...
                            PreferenceManager.getInstance().setCallFrontCameraResolution("");
                            Spinner frontSpinner = (Spinner) findViewById(cn.ucai.superwechat.R.id.spinner_video_resolution_front);
                            ...
                            PreferenceManager.getInstance().setCallBackCameraResolution("");
                            Spinner backSpinner = (Spinner) findViewById(cn.ucai.superwechat.R.id.spinner_video_resolution_back);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case cn.ucai.superwechat.R.id.rl_switch_fix_video_resolution:
                EaseSwitchButton swFixedVideoResolution = (EaseSwitchButton)findViewById(cn.ucai.superwechat.R.id.switch_fix_video_resolution);
                ...
                break;
            case cn.ucai.superwechat.R.id.rl_switch_offline_call_push:
                EaseSwitchButton swOfflineCallPush = (EaseSwitchButton)findViewById(cn.ucai.superwechat.R.id.switch_offline_call_push);
