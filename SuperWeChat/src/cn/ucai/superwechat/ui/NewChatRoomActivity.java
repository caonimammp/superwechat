...
public class NewChatRoomActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechat.R.layout.em_activity_new_chat_room);
		chatRoomNameEditText = (EditText) findViewById(cn.ucai.superwechat.R.id.edit_chat_room_name);
		introductionEditText = (EditText) findViewById(cn.ucai.superwechat.R.id.edit_chat_room_introduction);
	}
	...
	public void save(View v) {
		...
		if (TextUtils.isEmpty(name)) {
			...
			String st1 = getResources().getString(cn.ucai.superwechat.R.string.The_new_chat_room);
				...
				public void run() {
					try {
						...
						runOnUiThread(new Runnable() {
							public void run() {
								progressDialog.dismiss();
								final String st2 = getResources().getString(cn.ucai.superwechat.R.string.Failed_to_create_chat_room);
