...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(cn.ucai.easeui.R.layout.ease_fragment_contact_list, container, false);
    }
    ...
    protected void initView() {
        contentContainer = (FrameLayout) getView().findViewById(cn.ucai.easeui.R.id.content_container);
        
        contactListLayout = (EaseContactList) getView().findViewById(cn.ucai.easeui.R.id.contact_list);
...
//        String st1 = getResources().getString(cn.ucai.easeui.R.string.Is_moved_into_blacklist);
//        final String st2 = getResources().getString(cn.ucai.easeui.R.string.Move_into_blacklist_success);
//        final String st3 = getResources().getString(cn.ucai.easeui.R.string.Move_into_blacklist_failure);
//        pd.setMessage(st1);
