...
public class EaseShowNormalFileActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.easeui.R.layout.ease_activity_show_file);
		progressBar = (ProgressBar) findViewById(cn.ucai.easeui.R.id.progressBar);
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        if(file != null && file.exists()&&file.isFile())
                            file.delete();
                        String str4 = getResources().getString(cn.ucai.easeui.R.string.Failed_to_download_file);
