...
public class EaseSidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.ucai.easeui.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.ucai.easeui.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.ucai.easeui.R.drawable.ease_sidebar_background_pressed);
			return true;
		}
