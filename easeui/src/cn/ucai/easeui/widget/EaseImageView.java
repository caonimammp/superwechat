...
public class EaseImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, cn.ucai.easeui.R.styleable.EaseImageView);
            borderColor = array.getColor(cn.ucai.easeui.R.styleable.EaseImageView_ease_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(cn.ucai.easeui.R.styleable.EaseImageView_ease_border_width, borderWidth);
            pressAlpha = array.getInteger(cn.ucai.easeui.R.styleable.EaseImageView_ease_press_alpha, pressAlpha);
            pressColor = array.getColor(cn.ucai.easeui.R.styleable.EaseImageView_ease_press_color, pressColor);
            radius = array.getDimensionPixelOffset(cn.ucai.easeui.R.styleable.EaseImageView_ease_radius, radius);
            shapeType = array.getInteger(cn.ucai.easeui.R.styleable.EaseImageView_ease_shape_type, shapeType);
            array.recycle();
        }
