...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, cn.ucai.easeui.R.styleable.EaseConversationList);
        primaryColor = ta.getColor(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListPrimaryTextColor, cn.ucai.easeui.R.color.list_itease_primary_color);
        secondaryColor = ta.getColor(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListSecondaryTextColor, cn.ucai.easeui.R.color.list_itease_secondary_color);
        timeColor = ta.getColor(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListTimeTextColor, cn.ucai.easeui.R.color.list_itease_secondary_color);
        primarySize = ta.getDimensionPixelSize(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListPrimaryTextSize, 0);
        secondarySize = ta.getDimensionPixelSize(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListSecondaryTextSize, 0);
        timeSize = ta.getDimension(cn.ucai.easeui.R.styleable.EaseConversationList_cvsListTimeTextSize, 0);
