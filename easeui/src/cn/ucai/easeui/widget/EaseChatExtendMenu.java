...
public class EaseChatExtendMenu extends GridView{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, cn.ucai.easeui.R.styleable.EaseChatExtendMenu);
        int numColumns = ta.getInt(cn.ucai.easeui.R.styleable.EaseChatExtendMenu_numColumns, 4);
        ta.recycle();
    ...
    class ChatMenuItem extends LinearLayout {
        ...
        private void init(Context context, AttributeSet attrs) {
            LayoutInflater.from(context).inflate(cn.ucai.easeui.R.layout.ease_chat_menu_item, this);
            imageView = (ImageView) findViewById(cn.ucai.easeui.R.id.image);
            textView = (TextView) findViewById(cn.ucai.easeui.R.id.text);
        }
