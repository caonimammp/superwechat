...
public class EaseChatRowVideo extends EaseChatRowFile{
	...
	protected void onInflateView() {
		inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
				cn.ucai.easeui.R.layout.ease_row_received_video : cn.ucai.easeui.R.layout.ease_row_sent_video, this);
	}

	@Override
	protected void onFindViewById() {
	    imageView = ((ImageView) findViewById(cn.ucai.easeui.R.id.chatting_content_iv));
        sizeView = (TextView) findViewById(cn.ucai.easeui.R.id.chatting_size_iv);
        timeLengthView = (TextView) findViewById(cn.ucai.easeui.R.id.chatting_length_iv);
        ImageView playView = (ImageView) findViewById(cn.ucai.easeui.R.id.chatting_status_btn);
