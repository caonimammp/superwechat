...
public class EaseChatRowLocation extends EaseChatRow{
    ...
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                cn.ucai.easeui.R.layout.ease_row_received_location : cn.ucai.easeui.R.layout.ease_row_sent_location, this);
    }

    @Override
    protected void onFindViewById() {
    	locationView = (TextView) findViewById(cn.ucai.easeui.R.id.tv_location);
    }
