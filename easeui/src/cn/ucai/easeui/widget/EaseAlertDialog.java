...
public class EaseAlertDialog extends Dialog {
	...
	public EaseAlertDialog(Context context, int msgId) {
		super(context);
		this.title = context.getResources().getString(cn.ucai.easeui.R.string.prompt);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.easeui.R.layout.ease_alert_dialog);
		
		Button cancel = (Button)findViewById(cn.ucai.easeui.R.id.btn_cancel);
		Button ok = (Button)findViewById(cn.ucai.easeui.R.id.btn_ok);
		TextView titleView = (TextView) findViewById(cn.ucai.easeui.R.id.title);
		setTitle(title);
		
		View.OnClickListener listener = new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				if (view.getId() == cn.ucai.easeui.R.id.btn_ok) {
					onOk(view);
				} else if (view.getId() == cn.ucai.easeui.R.id.btn_cancel) {
					onCancel(view);
				}
			}
		};
		...
		if (msg != null)
		    ((TextView)findViewById(cn.ucai.easeui.R.id.alert_message)).setText(msg);
	}
