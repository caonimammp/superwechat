...
public class EaseChatInputMenu extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        layoutInflater.inflate(cn.ucai.easeui.R.layout.ease_widget_chat_input_menu, this);
        primaryMenuContainer = (FrameLayout) findViewById(cn.ucai.easeui.R.id.primary_menu_container);
        emojiconMenuContainer = (FrameLayout) findViewById(cn.ucai.easeui.R.id.emojicon_menu_container);
        chatExtendMenuContainer = (FrameLayout) findViewById(cn.ucai.easeui.R.id.extend_menu_container);

         // extend menu
         chatExtendMenu = (EaseChatExtendMenu) findViewById(cn.ucai.easeui.R.id.extend_menu);
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(chatPrimaryMenu == null){
            chatPrimaryMenu = (EaseChatPrimaryMenu) layoutInflater.inflate(cn.ucai.easeui.R.layout.ease_layout_chat_primary_menu, null);
        }
        primaryMenuContainer.addView(chatPrimaryMenu);

        // emojicon menu, use default if no customized one
        if(emojiconMenu == null){
            emojiconMenu = (EaseEmojiconMenu) layoutInflater.inflate(cn.ucai.easeui.R.layout.ease_layout_emojicon_menu, null);
            if(emojiconGroupList == null){
                emojiconGroupList = new ArrayList<EaseEmojiconGroupEntity>();
                emojiconGroupList.add(new EaseEmojiconGroupEntity(cn.ucai.easeui.R.drawable.ee_1,  Arrays.asList(EaseDefaultEmojiconDatas.getData())));
            }
