...
public class EaseEmojiconIndicatorView extends LinearLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), cn.ucai.easeui.R.drawable.ease_dot_emojicon_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(), cn.ucai.easeui.R.drawable.ease_dot_emojicon_unselected);
