...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase{
	...
	private void init(Context context, AttributeSet attrs){
		LayoutInflater.from(context).inflate(cn.ucai.easeui.R.layout.ease_widget_emojicon, this);
		TypedArray ta = context.obtainStyledAttributes(attrs, cn.ucai.easeui.R.styleable.EaseEmojiconMenu);
        int defaultColumns = 7;
        emojiconColumns = ta.getInt(cn.ucai.easeui.R.styleable.EaseEmojiconMenu_emojiconColumns, defaultColumns);
        int defaultBigColumns = 4;
        bigEmojiconColumns = ta.getInt(cn.ucai.easeui.R.styleable.EaseEmojiconMenu_bigEmojiconRows, defaultBigColumns);
		ta.recycle();
		
		pagerView = (EaseEmojiconPagerView) findViewById(cn.ucai.easeui.R.id.pager_view);
		indicatorView = (EaseEmojiconIndicatorView) findViewById(cn.ucai.easeui.R.id.indicator_view);
		tabBar = (EaseEmojiconScrollTabBar) findViewById(cn.ucai.easeui.R.id.tab_bar);
